...
def plotMaps_pcolormesh(data, figName, values, mapa, lons2d, lats2d, stations, var, cbar_l):
    '''
...
#        print
        ...
        vvv.append(vv)
        #if (vv > 5):
        #    print(vv, item[1], item[2])
        #print(vv, mapa, bn, x, y)
#        plt.scatter(x, y, c=vv, s=160, edgecolors='black')
#        plt.scatter(x, y, 10, marker='o', color='Red')
    plt.scatter(xx, yy, c=vvv, s=200, marker='o', cmap=mapa, vmin=values[0], vmax=values[-1], norm=bn, edgecolors='black', zorder=3)
...
main_folder = "/scratch/teufel/Caio/glacier2/GEM/Output/{0}".format(exp)
...
for per in period:
    for h in height:
        ...
        for var in varlist:
            ...
            #open station file
            sta = open('/aos/home/cruman/Documents/Scripts/plot_inversion/inv_list_{0}.dat'.format(per), 'r')
            ...
            plotMaps_pcolormesh(data, figName, values, cmap, lons2d, lats2d, stations, var, cbar_l)
